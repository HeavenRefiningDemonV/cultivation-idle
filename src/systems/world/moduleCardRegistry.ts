...
const DEFINITION_LIST: readonly WorldModuleCardDefinition[] = [
  ...
  },
  {
    ...
    sortOrder: 4,
    roleTag: 'Gate Prep',
    bestUsedWhen: 'Best used when you need immediate readiness through buying, brewing, or pouch restock.',
    defaultOutputs: [{ key: 'healing_stock', label: 'Healing Stock' }, { key: 'gate_prep', label: 'Gate Prep' }],
  ...
  },
  {
    ...
    bestUsedWhen: 'Best used when you need permanent refine, temper, or rune floor progress.',
    defaultOutputs: [{ key: 'refines', label: 'Refines' }, { key: 'runes', label: 'Runes' }],
    ctaLabel: 'Open Forge',
  ...
  },
  {
    ...
    bestUsedWhen: 'Best used when you need build correction, manual options, or scout-route support.',
  ...
  },
  {
    ...
    group: 'support',
    sortOrder: 7,
    roleTag: 'Support Currency',
    bestUsedWhen: 'Best used when you need support-economy progress, refreshes, or route guidance.',
