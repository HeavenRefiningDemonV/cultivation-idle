...
export type TargetedMaterialId = (typeof TARGETED_MATERIAL_IDS)[number];

export interface TargetedMaterialSinkMapEntry {
  materialId: TargetedMaterialId;
  cityId: string;
  primarySinkIds: string[];
  secondarySinkIds: string[];
}

export const TARGETED_MATERIAL_SINK_MAP: readonly TargetedMaterialSinkMapEntry[] = [
  {
...
const TARGETED_MATERIAL_SINK_MAP_BY_ID = Object.fromEntries(
  TARGETED_MATERIAL_SINK_MAP.map((entry) => [entry.materialId, entry]),
) as Record<TargetedMaterialId, TargetedMaterialSinkMapEntry>;

export function getTargetedMaterialSinkMapEntry(materialId: TargetedMaterialId): TargetedMaterialSinkMapEntry {
  return TARGETED_MATERIAL_SINK_MAP_BY_ID[materialId];
}

export function listTargetedMaterialSinkMap(): TargetedMaterialSinkMapEntry[] {
