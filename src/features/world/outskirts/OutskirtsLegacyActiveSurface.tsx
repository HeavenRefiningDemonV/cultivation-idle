...
import { OutskirtsActiveContainment } from './components/OutskirtsActiveContainment.js';

import wildBoar from "../../../assets/enemies/widboar.png";

import "../../../components/screens/world/buildings/CombatStyles.scss";
...
interface OutskirtsLegacyActiveSurfaceProps {
  cityId: string;
}

export function OutskirtsLegacyActiveSurface({ cityId }: OutskirtsLegacyActiveSurfaceProps) {
  ...
  const handlePrimaryAction = handleStopOutskirts;
