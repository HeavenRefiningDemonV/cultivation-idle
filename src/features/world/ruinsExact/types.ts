...
export interface RuinsTopRibbonSurface { markers: ReadonlyArray<{ id: string; active: boolean }>; }
export type RuinsTacticalCellId = 'hp' | 'depth' | 'loadout' | 'aiProfile' | 'healing' | 'bounty' | 'expedition';
export interface RuinsTacticalCellSurface { id: RuinsTacticalCellId; label: string; primaryText: string; secondaryText?: string; iconKey: string; tone: RuinsTacticalTone; showCaret: boolean; showUnderlineBar: boolean; underlineBarPct?: number; visible: boolean; source: RuinsExactValueSource; }
export interface RuinsTacticalStripSurface { cells: readonly [RuinsTacticalCellSurface, RuinsTacticalCellSurface, RuinsTacticalCellSurface, RuinsTacticalCellSurface, RuinsTacticalCellSurface, RuinsTacticalCellSurface, RuinsTacticalCellSurface]; }
export interface RuinsAreaHeaderSurface { plaqueLabel: string; showDropdownCaret: true; subtitle: string; chips: ReadonlyArray<{ id: string; label: string }>; }
