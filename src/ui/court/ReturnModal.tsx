 ...
 * exists; single-meridian (only the active meridian trains offline, §2.12/D13). The
 * focus trap + focus restore are added in W10.
 */
export function ReturnModal({ summary, onResume }: { summary: CourtOfflineSummary | null; onResume?: () => void }) {
  ...
  return (
    <div className="court-return-wrap">
      ...
      <div className="court-return" role="dialog" aria-modal="true" aria-label="While you were away">
