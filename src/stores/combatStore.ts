...
import { buildOutskirtsRewardBundle } from '../systems/economy/activityRewardRuntime.js';
  ...
  immer((set, get) => {
    ...
    defeatEnemy: () => {
      ...
      if (combatContext.type === 'outskirts') {
        ...
        const rewards = buildOutskirtsRewardBundle({ outskirtsDef, dropsConfig: economy?.drops?.outskirts, cityIndex, isBoss: isBossFight });
