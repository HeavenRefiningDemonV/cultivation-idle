import { listProgressionFixtures, type FixturePacketId, type FixtureTag } from '../tests/fixtures/progression/index.js';
...
const fixtures = listProgressionFixtures({
  packet: (packetArg?.split('=')[1] as FixturePacketId | undefined) ?? undefined,
  tag: (tagArg?.split('=')[1] as FixtureTag | undefined) ?? undefined,
});
