...
| `dao-heart-study` | Dao Heart — Study tab | ritual modal | `/?uiAudit=section-c&surface=dao-heart-study&fx=high` | CAPTURE PENDING — MANUAL | live | Current tab shell plus dedicated study-state/technique summary surface inside DaoHeart modal. | C.3 | Manual evidence capture is still pending. |
