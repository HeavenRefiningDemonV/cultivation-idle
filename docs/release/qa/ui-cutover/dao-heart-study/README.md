# dao-heart-study baseline capture

- Surface id: `dao-heart-study`
- Family: `ritual modal`
...
- `02-interaction.png` — required (study widget interactions).
- `03-truth-states.png` — **N/A unless a distinct truth-state set is visible**; document reason in capture notes.
