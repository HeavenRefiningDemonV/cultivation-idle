...
| World | `docs/release/qa/ui-cutover/phase-0-core-screens/04-world/` | missing | missing | missing | missing | missing | missing | `DEFERRED` | Required `01-06` files not present; WR-00 baseline remains diagnostic-only and WR-09 gate evaluation keeps cleanup locked until canonical captures exist. |
