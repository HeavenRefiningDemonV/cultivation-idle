...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| world | `WorldScreen` | City map + city package routing owner | `TopRibbon`, `InspectorPanel`, `InspectorDrawer`, `RunCompass` | `WorldFxScene` atmospheric support (quality/reduced-motion aware) | `phase0CoreAudit` `surface=world` (`high`,`low`,`reduced`) | `docs/release/qa/ui-cutover/phase-0-core-screens/04-world` | WR-09 signoff deferred pending canonical screenshot completion (`01-06`) | Primary proof surface |
