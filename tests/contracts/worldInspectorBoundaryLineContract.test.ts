...
import { OUTSKIRTS_BOUNDARY_LINE } from '../../src/systems/economy/activityRewardReadModel.js';

void test('world inspector boundary line is shown for outskirts and suppressed for other modules', () => {
  assert.equal(
  ...
  assert.equal(
    resolveWorldInspectorBoundaryLine({ moduleKey: 'ruins', boundaryLineFromHandoff: 'Gold is secondary here.' }),
    null,
  );
