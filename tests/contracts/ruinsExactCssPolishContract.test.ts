...
void test('ruins exact css polish contract owns exact layout and excludes legacy tokens', () => {
  ...
  for (const token of ['.ruinsExactPage', 'display: grid', 'grid-template-rows: auto minmax(0, 1fr)', '.ruinsExactPage__bodyCluster', 'grid-template-columns: var(--ruins-left-rail-width) minmax(0, 1fr) var(--ruins-right-rail-width)', "grid-template-areas: 'left . right' 'left scenic right' 'left route summary' '. cta summary'", '.ruinsExactPage__centerScenic', '.ruinsTargetedMaterialsCard', '.ruinsRoomRouteStrip', '.ruinsPrimaryCta', '.ruinsExplorationSummaryCard', '.ruinsTopRegion__tacticalIconDock', '.ruinsTopRegion__tacticalIcon', '.ruinsTopRegion__tacticalText', '.ruinsTopRegion__tacticalAdornment', '.ruinsTopRegion__tacticalDotDock', '--ruins-page-inline-padding', '--ruins-page-block-padding', '--ruins-left-rail-width', '--ruins-right-rail-width', '--ruins-rail-gap', '--ruins-body-scene-top-offset', '--ruins-scenic-height', '--ruins-route-row-height', '--ruins-cta-row-height', '--ruins-left-card-height', '--ruins-right-card-height', '--ruins-summary-width', '--ruins-summary-height', '--ruins-summary-drop-offset', 'grid-template-rows: var(--ruins-body-scene-top-offset) var(--ruins-scenic-height) var(--ruins-route-row-height) var(--ruins-cta-row-height)', 'min-width: 0', 'overflow: hidden', 'text-overflow: ellipsis', '@media (max-width: 1600px)', '@media (max-width: 1400px)', 'aspect-ratio:1/1']) {
