...
void test('buildOutskirtsMockupSurface emits v2 shape with explicit shell contract', () => {
  ...
  assert.equal(surface.scenicStage.reviewFixtureImageSrc.includes('/assets/mockups/ChatGPT Image Apr 17, 2026, 04_24_04 PM.png'), true);
...
void test('buildOutskirtsMockupSurface preserves v2 structure for live-like values', () => {
  ...
  assert.equal(surface.scenicStage.liveFallbackImageSrc.includes('/assets/background/citystates/city_outskirts.png'), true);
