...
export function getLiveForgeFloorReadModel(options = {}) {
    ...
    const inventoryRuneCounts = Object.fromEntries(Object.keys(content.maps.runesById).map((runeId) => [runeId, inventory.getQty(runeId)]));
