...
const CUMULATIVE_MILESTONE_TARGETS = Object.freeze(PHASE_TARGETS.reduce((acc, phase) => {
...
export function getPinewindTargetDurationSeconds() {
...
export function getFoundationEntryTargetSecondsFromLifeStart() {
...
export function getPhaseValidationToleranceSeconds(targetSeconds) {
...
export function buildPhaseTimingReport(input) {
