...
export const ACTIVITY_LOOP_ROLE_OWNERSHIP = Object.freeze({
    outskirts: {
        ...
        status: 'locked',
        primaryCategories: ['goldPerMinute', 'commonMaterialUnitsPerMinute'],
        secondaryCategories: ['bossSpiritStoneSupportPerHour'],
    },
    ruins: {
        activityId: 'ruins',
        status: 'locked',
        primaryCategories: ['targetedMaterialUnitsPerMinute', 'anchorUnitsPerRun', 'shortageRecoveryValue'],
        secondaryCategories: ['rareBundleCadence'],
    },
    bounties: {
        activityId: 'bounties',
        status: 'locked',
        primaryCategories: ['bossSpiritStoneSupportPerHour'],
        secondaryCategories: ['goldPerMinute'],
    },
    expeditions: {
        activityId: 'expeditions',
        status: 'locked',
        primaryCategories: ['shortageRecoveryValue'],
        secondaryCategories: ['targetedMaterialUnitsPerMinute'],
    },
});
...
export function getActivityProbeDurationSeconds(activityId, cityIndex) {
...
export function getBountyClaimCadenceMinutes(cityIndex) {
    const safeIndex = Math.max(0, Math.min(4, Math.floor(cityIndex)));
