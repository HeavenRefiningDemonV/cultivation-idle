...
import { getTransitionByFromRealm, normalizeGateItemAlias, } from '../../src/systems/progression/contract/index.js';
...
test('post-first-gate fixture records an explicit clear state instead of an ambiguous resolved bucket', async () => {
    ...
    const progress = fixture.saveShape?.trialState?.progressByTrialId
