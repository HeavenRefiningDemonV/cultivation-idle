...
export const KNOWN_ISSUES_LEDGER: ReadonlyArray<KnownIssueLedgerEntry> = Object.freeze([
  ...
  {
    issueId: 'debt_progression_gate_namespace_split',
    sourceCheckId: 'progression_contract',
    classification: 'post_semester_debt',
    title: 'GATE_NAMESPACE_SPLIT',
    owner: 'progression',
    ...
    evidencePaths: ['docs/progression-contract.md', 'docs/progression-fixtures.md'],
    firstRecordedAt: '2026-03-27',
    lastReviewedAt: '2026-03-27',
    status: 'open',
    expiresAt: '2026-06-30',
  ...
  {
    issueId: 'debt_progression_offline_pipeline_split',
    sourceCheckId: 'progression_contract',
    classification: 'post_semester_debt',
  ...
  {
    issueId: 'debt_progression_hidden_prestige_runtime_consumer',
    sourceCheckId: 'progression_contract',
    classification: 'post_semester_debt',
    title: 'HIDDEN_PRESTIGE_RUNTIME_CONSUMER',
    owner: 'progression',
  ...
  {
    issueId: 'debt_progression_partial_prestige_reset',
    sourceCheckId: 'progression_contract',
    classification: 'post_semester_debt',
    title: 'PARTIAL_PRESTIGE_RESET',
    owner: 'progression',
