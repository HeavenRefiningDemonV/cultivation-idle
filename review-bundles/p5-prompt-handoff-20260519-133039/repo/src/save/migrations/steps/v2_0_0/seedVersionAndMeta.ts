...
export const v2_0_0_seed_version_and_meta: MigrationStep = {
  ...
  run: (save, ctx) => {
    ...
    const fallbackLastActiveAtMs =
      (typeof meta.lastActiveAtMs === 'number' ? meta.lastActiveAtMs : undefined) ??
    ...
    return createStepResult(
      ...
      next,
      mutated ? 'Seeded version/meta normalization for semester save v2.0.0.' : 'Version/meta already normalized.',
      { didMutate: mutated, touchedFieldPaths: touched },
    );
  },
};
