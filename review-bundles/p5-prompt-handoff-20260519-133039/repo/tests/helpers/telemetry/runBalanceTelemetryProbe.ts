...
export function runBalanceTelemetryProbe() {
  ...
  GameEvents.emit({ type: 'rewards/granted', payload: { timestamp: start + 162_000, reason: 'Gate Trial clear', summary: 'ok', bundle: { currencies: { merit: '40' } }, result: { appliedCurrencies: { merit: '40' }, appliedItems: [], droppedItems: [], appliedTechniqueFragments: [], appliedManuals: [], appliedComprehension: null, skippedRewards: [] } } });
  GameEvents.emit({ type: 'rewards/granted', payload: { timestamp: start + 163_000, reason: 'expedition_claim:scout:medium:city=city_pinewind_hamlet', summary: 'ok', bundle: { currencies: { spiritStones: '5' } }, result: { appliedCurrencies: { spiritStones: '5' }, appliedItems: [], droppedItems: [], appliedTechniqueFragments: [], appliedManuals: [], appliedComprehension: null, skippedRewards: [] } } });
  GameEvents.emit({ type: 'rewards/granted', payload: { timestamp: start + 164_000, reason: 'Bounty:resolved', summary: 'ok', bundle: { currencies: { merit: '10' } }, result: { appliedCurrencies: { merit: '10' }, appliedItems: [], droppedItems: [], appliedTechniqueFragments: [], appliedManuals: [], appliedComprehension: null, skippedRewards: [] } } });
  GameEvents.emit({ type: 'rewards/granted', payload: { timestamp: start + 165_000, reason: 'Gate Trial eligible defeat:trial_g1', summary: 'ok', bundle: { currencies: { merit: '5' } }, result: { appliedCurrencies: { merit: '5' }, appliedItems: [], droppedItems: [], appliedTechniqueFragments: [], appliedManuals: [], appliedComprehension: null, skippedRewards: [] } } });
