...
export function buildPhase6CombatPreflightReport(rootDir: string): PreflightReport {
  ...
  const visibleTruthSurfaceInventory: SurfaceInventory[] = [
    ...
    },
    {
      ...
      runCompassCompact: 'Top tactical strip stays compact above the exact page body (HP/Depth/Loadout/AI/Healing/Bounty/Expedition).',
      scenicOwnerDescription: 'Screen-owned exact route via RuinsBuildingPanel -> RuinsScreenOwner -> RuinsExactMockupScreen with a center scenic stage slot.',
      sidePanelTruthSurfaces: ['Ruin Kit left rail', 'Targeted Materials right rail', 'Hollow Log Den Route strip', 'Exploration Summary dock'],
      primaryCta: 'Continue Exploration',
      trackedBountyLine: 'Present when tracked bounty kind is RUINS_ROOM_CLEAR or RUINS_RUN_CLEAR',
      aiPostureHint: 'No dedicated AI hint row; tactical and kit truth remains explicit in exact slots',
      deterministicAnchorVisibility: 'Guaranteed Anchor line with Core Fragment x1 / Final Chest in Targeted Materials card',
      pityVisibility: 'Rare Pity line is visible in Targeted Materials card',
      minimumChecklistVisibility: 'Not applicable',
      recommendedChecklistVisibility: 'Not applicable',
      failSafeVisibility: 'Not applicable',
      diagnosisVisibility: 'Not applicable',
      adjacentRouteCues: 'Hollow Log Den Route strip plus route medallion labels in-page',
    },
    {
  ...
  return {
    ...
    ownershipMap: {
      ...
      ruins: [
        ...
        'src/features/world/ruinsExact/RuinsExactMockupScreen.ts',
        'src/features/world/ruinsExact/buildRuinsExactSurface.ts',
        'src/features/world/ruinsExact/components/RuinsTopRegion.ts',
        'src/features/world/ruinsExact/components/RuinsKitCard.ts',
        'src/features/world/ruinsExact/components/RuinsScenicStage.ts',
        'src/features/world/ruinsExact/components/RuinsTargetedMaterialsCard.ts',
        'src/features/world/ruinsExact/components/RuinsRoomRouteStrip.ts',
        'src/features/world/ruinsExact/components/RuinsPrimaryCta.ts',
        'src/features/world/ruinsExact/components/RuinsExplorationSummaryCard.ts',
      ],
      'gate-trial': [
    ...
    ownerFileMatrix: Object.entries({
      ...
      ruins: ['moduleCardRegistry.ts', 'RuinsBuildingPanel.tsx', 'RuinsScreenOwner.tsx', 'RuinsExactMockupScreen.ts', 'buildRuinsExactSurface.ts'],
